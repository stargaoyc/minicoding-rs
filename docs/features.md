...
| L-05 | 重试与限流 | 指数退避（±20% 抖动防 thundering herd）、429 Retry-After、Client 读超时 300s 防停发挂起 | M6 | 已实现 |
...
| M7 | 4 | 10 | P2（TUI） |
| M8 | 9 | 10 | P2（SDK/Server；R3 对齐 dev-plan 附录 T-M8-1..9） |
| **合计** | **74** | **83** | — |
